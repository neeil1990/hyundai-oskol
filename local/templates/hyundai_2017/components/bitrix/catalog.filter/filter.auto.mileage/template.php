...
<div class="autos_list_head">
    ...
    <form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter form_search_block">
        ...
        <div class="lg_50">
            <select class="drop-it-down js-drop-it-down" name="arrFilter_pf[FUEL_TYPE]" id="">
                <option value="">Тип коробки передач</option>
                <? foreach($arResult['VALUE']['FUEL_TYPE'] as $model): ?>
                    <option value="<?=$model?>"><?=$model?></option>
                <? endforeach; ?>
            </select>
        </div>
        ...
        <div class="hidden_filter">
            <div class="lg_50">
                ...
                <div class="range-slider-from-to js-range-slider-from-to js-range-slider-from-to__decimal mobile_hidden_block">
                    ...
                    <span class="range-slider__input left">
					<span class="range-slider__input-title">от</span>
					<span class="range-slider__input-value">0.2</span>
					<input class="range-slider__min js-range-slider__min" name="arrFilter_8_MIN"
                           value="0.2"
                           data-basic-value="0.2" type="text">
				</span>
                    <span class="range-slider__input right">
					<input class="range-slider__max js-range-slider__max" name="arrFilter_8_MAX"
                           value="3.8"
                           data-basic-value="3.8" type="text">
					<span class="range-slider__input-value">3.8</span>
					<span class="range-slider__input-title">до</span>
				</span>
                    <div class="range-slider__padding">
                    </div>
            ...
            <div class="lg_100">
                <h3 class="hidden_block_toggle">Комфорт</h3>
            </div>
            <div class="clearfix"></div>
            <div class="mobile_hidden_block">
                        ...
                        <div class="drop-it-down-custom custom-multiple js-multiple-drop-it-down">
                            ...
                            <div class="drop-it-down-custom__list-wrap">
                                <ul class="drop-it-down-custom__list">
                                    <!--<li class="drop-it-down-custom__option js-custom-multiple__list-title"></li>-->
            ...
            <div class="clearfix"></div>
            <div class="lg_100">
                <h3 class="hidden_block_toggle">Экстерьер</h3>
            </div>
            <div class="clearfix"></div>

            <div class="props_values_block mobile_hidden_block">
                <div class="lg_33">
                    <label>
            ...
            <div class="clearfix"></div>
            <div class="lg_100">
                <h3 class="hidden_block_toggle">Безопасность</h3>
            </div>
            <div class="clearfix"></div>
            <div class="mobile_hidden_block">
                <div class="clearfix"></div>
    ...
    <div class="lg_100 action_banner_tablet">
        <a href="/avtomobili-s-probegom/?sort-type=price%3Aasc&arrFilter_94=1659719199&arrFilter_4=2691610470&arrFilter_24=&arrFilter_6=&arrFilter_7=&arrFilter_16_MIN=0&arrFilter_16_MAX=438514&arrFilter_36_MIN=140000&arrFilter_36_MAX=2609317&arrFilter_14_MIN=&arrFilter_14_MAX=&arrFilter_8_MIN=1&arrFilter_8_MAX=15&set_filter=#search-results">
            <img style="max-width: 100%;" src="/local/templates/hyundai_2017/img/banner_table.png" alt="" />
            <div class="clearfix"></div>
        </a>
        <div class="clearfix"></div>
    </div>
    <div class="clearfix"></div>
    <div class="lg_100 action_banner_mobile">
        <a href="/avtomobili-s-probegom/?sort-type=price%3Aasc&arrFilter_94=1659719199&arrFilter_4=2691610470&arrFilter_24=&arrFilter_6=&arrFilter_7=&arrFilter_16_MIN=0&arrFilter_16_MAX=438514&arrFilter_36_MIN=140000&arrFilter_36_MAX=2609317&arrFilter_14_MIN=&arrFilter_14_MAX=&arrFilter_8_MIN=1&arrFilter_8_MAX=15&set_filter=#search-results">
            <img style="max-width: 100%;" src="/local/templates/hyundai_2017/img/banner_mobile.png" alt="" />
            <div class="clearfix"></div>
        </a>
        <div class="clearfix"></div>
    </div>
